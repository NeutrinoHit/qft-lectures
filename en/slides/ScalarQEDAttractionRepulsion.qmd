...
![](media/scalar-qed-attraction-repulsion/boats.jpg){.slide-image-center .nostretch width=80% fig-align="center" fig-alt="A qualitative picture for the repulsion"}

# How to explain the attraction?

## Attraction picture: looks reasonable too?
![](media/scalar-qed-attraction-repulsion/boats2.jpg){.slide-image-center .nostretch width=80% fig-align="center" fig-alt="A qualitative picture for the attraction"}
...
:::: {.story-picture-pair}
::: {}
![](media/scalar-qed-attraction-repulsion/boats.jpg){fig-alt="Qualitative boat picture for repulsion"}
:::

::: {}
![](media/scalar-qed-attraction-repulsion/boats2.jpg){fig-alt="Qualitative boat picture for attraction"}
:::
::::
